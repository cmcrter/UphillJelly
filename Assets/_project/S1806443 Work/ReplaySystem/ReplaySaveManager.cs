...
public class ReplaySaveManager : MonoBehaviour {
    ...
    public void SaveReplay1() {
        ...
        if (isMapOldTown) {
            ...
            if (!IsReplaySaveFile1()) {
                ...
                // create a save file in the data path folder called /replay_save
                Directory.CreateDirectory(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map");

            }

            // if a directory doesn't exists for "/replay_save/replay_data"
            if (!Directory.Exists(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map")) {
            ...
            // create a filestream in the replay data and call it "replay_SavedData"
            FileStream replay_file1 = File.Create(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map/Replay_SavedData1.sdat");
    ...
    public void LoadReplay1() {
        ...
        if (isMapOldTown) {
            ...
            // if a directory doesn't exists for "/replay_save/replay_data"
            if (!Directory.Exists(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map/Replay_SavedData1")) {

                // create a directory for "/replay_save/replay_data"
                Directory.CreateDirectory(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map/Replay_SavedData1");
            ...
            // if a file exists called "/replay_save/replay_data/replay_SavedData.txt"
            if (File.Exists(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map/Replay_SavedData1.sdat")) {

                // open the file "/replay_save/replay_data/replay_SavedData.txt"
                FileStream file1 = File.Open(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map/Replay_SavedData1.sdat", FileMode.Open);
    ...
    public void SaveSecondReplay1() {
        ...
        if (isMapOldTown) {
            ...
            // create a filestream in the replay data and call it "replay_SavedData"
            FileStream replay_secondFile1 = File.Create(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map/Replay_SecondSavedData1.sdat");
    ...
    public void LoadSecondReplay1() {
        ...
        if (isMapOldTown) {
            ...
            if (File.Exists(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map/Replay_SavedData1.sdat")) {
                ...
                // open the file "/replay_save/replay_data/replay_SavedData.txt"
                FileStream replay_secondFile1 = File.Open(Application.persistentDataPath + "/Profile1/Replays/Old_Town_Map/Replay_SavedData1.sdat", FileMode.Open);
    ...
    public void SaveReplay2() {
        ...
        if (isMapOldTown) {
            ...
            // create a filestream in the replay data and call it "replay_SavedData"
            FileStream replay_file2 = File.Create(Application.persistentDataPath + "/Profile2/Replays/Old_Town_Map/Replay_SavedData2.sdat");
    ...
    public void LoadReplay2() {
        ...
        if (isMapOldTown) {
            ...
            // if a file exists called "/replay_save/replay_data/replay_SavedData.txt"
            if (File.Exists(Application.persistentDataPath + "/Profile2/Replays/Old_Town_Map/Replay_SavedData2.sdat")) {

                // open the file "/replay_save/replay_data/replay_SavedData.txt"
                FileStream file2 = File.Open(Application.persistentDataPath + "/Profile2/Replays/Old_Town_Map/Replay_SavedData2.sdat", FileMode.Open);
    ...
    public void SaveSecondReplay2() {
        ...
        if (isMapOldTown) {
            ...
            // create a filestream in the replay data and call it "replay_SavedData"
            FileStream replay_secondFile2 = File.Create(Application.persistentDataPath + "/Profile2/Replays/Old_Town_Map/Replay_SecondSavedData2.sdat");
    ...
    public void LoadSecondReplay2() {
        ...
        if (isMapOldTown) {
            ...
            if (File.Exists(Application.persistentDataPath + "/Profile2/Replays/Old_Town_Map/Replay_SavedData2.sdat")) {
                ...
                // open the file "/replay_save/replay_data/replay_SavedData.txt"
                FileStream secondFile2 = File.Open(Application.persistentDataPath + "/Profile2/Replays/Old_Town_Map/Replay_SavedData2.sdat", FileMode.Open);
    ...
    public void SaveReplay3() {
        ...
        if (isMapOldTown) {
            ...
            // create a filestream in the replay data and call it "replay_SavedData"
            FileStream replay_file3 = File.Create(Application.persistentDataPath + "/Profile3/Replays/Old_Town_Map/Replay_SavedData3.sdat");
    ...
    public void LoadReplay3() {
        ...
        if (isMapOldTown) {
            ...
            // if a file exists called "/replay_save/replay_data/replay_SavedData.txt"
            if (File.Exists(Application.persistentDataPath + "/Profile3/Replays/Old_Town_Map/Replay_SavedData3.sdat")) {

                // open the file "/replay_save/replay_data/replay_SavedData.txt"
                FileStream file3 = File.Open(Application.persistentDataPath + "/Profile3/Replays/Old_Town_Map/Replay_SavedData3.sdat", FileMode.Open);
    ...
    public void SaveSecondReplay3() {
        ...
        if (isMapOldTown) {
            ...
            // create a filestream in the replay data and call it "replay_SavedData"
            FileStream replay_secondFile3 = File.Create(Application.persistentDataPath + "/Profile3/Replays/Old_Town_Map/Replay_SecondSavedData3.sdat");
    ...
    public void LoadSecondReplay3() {
        ...
        if (isMapOldTown) {
            ...
            if (File.Exists(Application.persistentDataPath + "/Profile3/Replays/Old_Town_Map/Replay_SavedData3.sdat")) {
                ...
                // open the file "/replay_save/replay_data/replay_SavedData.txt"
                FileStream secondFile3 = File.Open(Application.persistentDataPath + "/Profile3/Replays/Old_Town_Map/Replay_SavedData3.sdat", FileMode.Open);
